    ...
    function searchBydate() {
      ...
      if(search_first_date_=='' || search_last_date_==''){
        ...
        $.ajax({
            url: '/teacher/report?from_date='+search_first_date_+'&to_date='+search_last_date_+'&gettype=initialpage',
  ...
  <div class="col-md-12">
		...
		<div class="x_title">
		  <script type="text/javascript"></script>
		    <h2>Teacher <small>Report view </small></h2>
        ...
        <div id="data_table_container">
          ...
          @include('reports.pagination-teacher')

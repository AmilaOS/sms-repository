    ...
    function searchBydate() {
      ...
      if(search_first_date_=='' || search_last_date_==''){
        ...
        $.ajax({
            url: '/systemuser/report?from_date='+search_first_date_+'&to_date='+search_last_date_+'&gettype=initialpage',
  ...
  <div class="col-md-12">
        ...
        <div id="data_table_container">
          ...
          @include('reports.pagination-systemuser')

          <div style="float: right;"><a class="btn-sm btn-primary" href="/register" target="blank"><i class="fa fa-plus"></i>  New System User</a></div>

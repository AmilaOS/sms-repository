...
<html lang="en">
  ...
  <body class="nav-sm" style="color: black;"> 
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a style="display: none;" href="javascript:" id="hide_dash_icon_id"><div style="background-image: url('../images/icons/dashboard.png');background-size: cover; height:30px;width:30px;margin-top: 15px;margin-left: 15px;" style="font-size: 11px;" aria-hidden="true"></div> Dashboard <span class="fa fa-chevron-down"></span></a>

                    <a href="javascript:" id="hide_menu_icon_id"><div style="background-image: url('../images/icons/menu.png');background-size: cover; height:30px;width:30px;margin-top: 15px;margin-left: 15px;" style="font-size: 11px;" aria-hidden="true"></div> Menu <span class="fa fa-chevron-down"></span></a>
                  </li>

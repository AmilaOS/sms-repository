                      ...
                      <div class="bs-glyphicons">
                        ...
                        <a href="/student">
                           <li style="margin: 24px; height:165px;width:150px;color: white;">
                            <div style="background-image: url('../images/icons/student.svg');background-size: cover; height:100px;width:100px;margin-top: 15px;margin-left: 15px;" style="font-size: 80px;" aria-hidden="true"></div>
                            <span class="glyphicon-class" style="font-size: 14px;margin-top: 10px; color:black;">Student</span>
                          </li>
                        </a>
                          <a href="/lecture">
                          <li style="margin: 24px; height:165px;width:150px;color: white;">
                            <div style="background-image: url('../images/icons/classroom.svg');background-size: cover; height:100px;width:100px;margin-top: 15px;margin-left: 15px;" style="font-size: 80px;" aria-hidden="true"></div>
                            <span class="glyphicon-class" style="font-size: 14px;margin-top: 10px; color:black;">Lectures</span>
                          </li>
                        </a>

                         <a href="/lecturer">
                         <li style="margin: 24px; height:165px;width:150px;color: white;">
                            <div style="background-image: url('../images/icons/teacher.svg');background-size: cover; height:100px;width:100px;margin-top: 15px;margin-left: 15px;" style="font-size: 80px;" aria-hidden="true"></div>
                            <span class="glyphicon-class" style="font-size: 14px;margin-top: 10px; color:black;">Teacher</span>
                          </li>
                        </a>

                          <a href="/classroom">
                          <li style="margin: 24px; height:165px;width:150px;color: white;">
                            <div style="background-image: url('../images/icons/lecroom.svg');background-size: cover; height:100px;width:100px;margin-top: 15px;margin-left: 15px;" style="font-size: 80px;" aria-hidden="true"></div>
                            <span class="glyphicon-class" style="font-size: 14px;margin-top: 10px; color:black;">Classroom</span>
                          </li>
                        </a>

                        <a href="/lectureoperator">
                          <li style="margin: 24px; height:165px;width:150px;color: white;">
                            <div style="background-image: url('../images/icons/operator.svg');background-size: cover; height:100px;width:100px;margin-top: 15px;margin-left: 15px;" style="font-size: 80px;" aria-hidden="true"></div>
                            <span class="glyphicon-class" style="font-size: 14px;margin-top: 10px; color:black;">Operator</span>
                          </li>
                        </a>

                        <!-- <a href="/cardmarking">
                          <li style="margin: 24px; height:165px;width:150px;color: white;">
                            <div style="background-image: url('../images/icons/cardmarking.svg');background-size: cover; height:100px;width:100px;margin-top: 15px;margin-left: 15px;" style="font-size: 80px;" aria-hidden="true"></div>
                            <span class="glyphicon-class" style="font-size: 14px;margin-top: 10px; color:black;">Classroom</span>
                          </li>
                        </a> -->

    ...
    <div class="">
      <div class="row">
        ...
        <div class="col-md-10 col-sm-12 ">
          <div class="x_panel">
            <div class="x_title">
              <h2> New Lecure <small>Lecure Registration</small></h2>
              ...
              <form class="form-horizontal form-label-left" style="display: none">
                ...
                <div class="form-group row ">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="text" class="form-control" autofocus="" name="lecture_name" id="lecture_name" placeholder="Ex: Lecture-Economics-2019-01-01">
                  </div>
                </div>
                <div class="form-group row ">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="date" class="form-control" id="lecture_start_date" name="lecture_start_date" placeholder="">
                  </div>
                </div>
                <div class="form-group row ">
                  <label class="control-label col-md-3 col-sm-3 ">Lecture End Date </label>
                  <div class="col-md-9 col-sm-9 ">
                    <input type="date" class="form-control" id="lecture_end_date" name="lecture_end_date" placeholder="">
                  </div>
                </div>
                 <div class="form-group row ">
                  <label class="control-label col-md-3 col-sm-3 ">Lecture Fee <span style="font-size: 17px;" class="required text-danger">*</span></label>
                  <div class="col-md-9 col-sm-9 ">
                    <input type="text" class="form-control" autofocus="" name="lecture_fee" id="lecture_fee" placeholder="Ex: 1000">
                  </div>
                </div>
                <div class="form-group row">
